...
const navItems = [
  ...
  { href: '/cases/my-cases', label: 'My Cases', icon: ShieldCheck, roles: ['case_manager','secretariat'] },
  { href: '/cases/new', label: 'Submit Issue', icon: PlusCircle, roles: ['staff','secretariat','case_manager','admin'] },
